...
const CardSelectPlan = ({ className = "", img, title, price, children, onClick }: CardSelectPlanProps) => {
    return (
        <article className={`card-plans items-start justify-start gap-x-5 is-plan:border-blue-100 is-plan:bg-magnolia hover:cursor-pointer sm:p-5 ${className}`} onClick={onClick}>
